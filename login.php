...
<body>
    ...
    <section class="bg-gray d-flex justify-content-center aling-item-center vh-100">
        ...
        <div class="col"> <br>
            <div class="bg-white p-5 rounded-5 text-secundary shadow" width="30rem">
                ...
                <div class="d-flex gap-1 justify-content-center mt-1">
                    ...
                    <a href="registro.php" class="text-decoration-none text-info fw-semibold">Registrarse</a>
                </div>
        ...
        <div class="col"><br><br><br><br><br><br>
            <div class="d-flex justify-content-center">
                <img src="images/logo_CAFECH.png" alt="logo-icon" width="350px" height="350px">
            </div>
        </div>
    </section>
